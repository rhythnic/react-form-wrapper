...
import { update as updateForm, buildPath, parseSchemaForFieldProps } from './pure-functions';
...
export default ({ schema, delimiter = '.', disableSubmit } = {}) => WrappedComponent => {
  ...
  class FormWrapper extends Component {
    constructor(props) {
      ...
      if (schema) {
        this._schema = schema;
        this._schemaProps = parseSchemaForFieldProps(schema);
        console.log(this._schemaProps);
      }
